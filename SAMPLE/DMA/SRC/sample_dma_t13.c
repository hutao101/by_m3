...
int dmac_32_32bit_iic2mem_cfg(int channel)
{
    u32 reg_value; 
...
/****************************************************************************
 * @brief   sample_dma_t13
 * Function test the IIC to SRAM dma transfer of src id 32,des is 32bit for per ch
 * @author  he
 * @date    2022-04-012
 * @param   
 ...
 * @return void
******************************************************************************/
void sample_dma_t13(int channel)
{
	
	dw_dmac_clearIrq(channel, IRQ_TYPE_ALL);
	dmac_32_32bit_iic2mem_cfg(channel);
...
/****************************************************************************
 * @brief   sample_dma_t13_8CH
 * Function test the IIC to SRAM dma transfer of src is 32,des is 32bit for 8ch
 * @author  he
 * @date    2022-04-02
 * @param   
		channel:DMA通道 of 0-7
...
void sample_dma_t13_8ch(void)
{
	...
	//write_ahb32(I2C1_BASE + I2C_DMA_TDLR, I2C_FIFO_DEPTH/2);
		...
		printf("\r\n0x20004B2C：0x%x\r\n",read_ahb32(0x20004B2C));
		printf("\r\n0x20004B30：0x%x\r\n",read_ahb32(0x20004B30));
		...
		write_ahb32(0x20004B2C,0x0);
		write_ahb32(0x20004B30,0x0);
