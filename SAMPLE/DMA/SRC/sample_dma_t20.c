...
int dmac_8bit_mem2iic_cfg_t20(int channel)
{
    u32 reg_value; 
 ...
 * @return  void
*******************************************************************************/ 
void sample_i2c_t1_dmat20(void)
{
...
void sample_dma_t20(int channel)
{
/*begin*****************顺序：IIC配置以及使能,DMA配置及使能、握手*******************/
	...
	dmac_8bit_mem2iic_cfg_t20(channel);
