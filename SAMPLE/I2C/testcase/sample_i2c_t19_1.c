...
/*******************************************************************************
 * @brief   sample_i2c_t19_1
* Function  Interrupt_I2C2:I2C_GEN_CALL
 * @author  licuihuang
 * @date    2022-4
 * @param   void
 * @return  void
...
void sample_i2c_t19_1(void)
{
	...
	i2c1_info.xfer_param.target_dev_addr = 0x0;  //set_addr
	...
	write_ahb32(i2c1_info.base_address +  I2C_INTR_MASK,status & I2C_GEN_CALL);    //[11]：I2C_GEN_CALL,1
