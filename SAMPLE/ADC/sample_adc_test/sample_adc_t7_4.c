...
/*******************************************************************************
 * @brief   sample_adc_t7_4
 * Function 间断模式:T2_CC2触发
 * @author  licuihuang
 * @date    2022-9-21
 * @param   void
 * @return  void
...
//	adc_tim_nvic_init(16);
//	TIM_ITConfig(TIM2, TIM_IT_CC2, ENABLE);
	
	temp = ADC_CTRL_FIFO_10 | ADC_EXTTRIG_Set | ADC_TrigConv_T2_CC2 | (2<<13); 
	...
	TIM_OCInitStructure.TIM_Pulse = 10000;       //第一次1s产生cc2事件,后面每隔2s产生cc2事件
