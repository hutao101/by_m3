...
* Function  Interrupt_I2C1:I2C_TX_OVER[3]
 * @author  licuihuang
 * @date    2022-4
 * @param   void
 * @return  void
...
void sample_i2c_t16(void)
{
	...
	write_ahb32(i2c1_info.base_address +  I2C_INTR_MASK,status & I2C_TX_OVER);             //[3]：I2C_TX_OVER,1 
	...
	write_ahb32(i2c1_info.base_address +  I2C_DATA_CMD,0x99 );  //[3]:TX_OVER 1 需在I2C_DATA_CMD写入别的命令
	delay_ms(2);
	printf("i2c1 write: I2C_INTR_STAT:0x%x\r\n",read_ahb32(i2c1_info.base_address +  I2C_INTR_STAT));					
