...
//m 2 p 32bit ccr4 pwm  msize = 1

void sample_timer_t22_toDma_t28(void)
{
	TIM1_NVIC_Init(33);
...
int dmac_32bit_mem2iic_cfg_t28(int channel)
{
    u32 reg_value; 
...
void sample_dma_t28(int channel)
{
