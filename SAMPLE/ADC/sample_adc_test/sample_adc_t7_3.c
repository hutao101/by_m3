...
/*******************************************************************************
 * @brief   sample_adc_t7_3
 * Function 间断模式:T1_CC3触发
 * @author  licuihuang
 * @date    2022-9-21
 * @param   void
 * @return  void
...
{	
	...
	temp = ADC_CTRL_FIFO_10 | ADC_EXTTRIG_Set | ADC_TrigConv_T1_CC3 | (2<<13); 
	...
	TIM_OCInitStructure.TIM_Pulse = 10000;       //第一次1s产生cc3事件,后面每隔2s产生cc3事件
