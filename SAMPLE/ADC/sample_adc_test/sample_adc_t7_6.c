...
/*******************************************************************************
 * @brief   sample_adc_t7_6
 * Function 间断模式:T4_CC4触发
 * @author  licuihuang
 * @date    2022-9-21
 * @param   void
 * @return  void
...
//	adc_tim_nvic_init(18);
//	TIM_ITConfig(TIM4, TIM_IT_CC4, ENABLE);
	
	temp = ADC_CTRL_FIFO_10 | ADC_EXTTRIG_Set | ADC_TrigConv_T4_CC4 | (2<<13); 
	...
	TIM_OCInitStructure.TIM_Pulse = 10000;       //第一次1s产生cc4事件,后面每隔2s产生cc4事件
