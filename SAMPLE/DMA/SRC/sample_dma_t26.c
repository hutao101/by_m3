...
//m 2 p 32bit ccr1 pwm

void sample_timer_t22_toDma_t26(void)
{
	TIM1_NVIC_Init(31);
...
int dmac_32bit_mem2iic_cfg_t26(int channel)
{
    u32 reg_value; 
...
//	printf("MCU_CFG: 0x%x\r\n",read_ahb32(MCU_CFG));
	...
	reg_value =    (0 << 7)| (3 << 11)		//Handshaking 3:TIMER1_CC1 MCU_CFG[14:12]=100			
...
void sample_dma_t26(int channel)
{
/*begin******************************顺序一 ：DMA 握手 TIM***************************/
	...
	dmac_32bit_mem2iic_cfg_t26(channel);  //DMA 初始化
